    ...
    <div className="App">
      ...
      >
        ...
        >
          ...
          />
          {inputpersegi.length > 0 && <h4>hasil dari luas persegi dengan sisi {inputpersegi} adalah {hasilpersegi}</h4>}
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          {alas.length > 0 && tinggi.length > 0 &&
            <h4>hasil dari luas segitiga dengan alas {alas} dan tinggi {tinggi} adalah {hasiltiga}</h4>}
        </div>
      </div>
    </div>
  );
